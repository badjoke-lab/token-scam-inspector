...
答えは可能
他のツール作成のときに放置運営でいくぞとやってたのでこのツールでも放置運営を考えてくれました。無駄に気が利きますね。
...
3案出してくれましたがオススメのCloudflare Pages + Workersにします。
もっと言うとこれはgithubでリポジトリを作ってそれをcouldflareで公開してそれにworkersでどうこうみたいな感じですね。よくわかってません


ということでgithubにリポジトリだけ作っておきました
